...
class Events extends Component {
    ...
    render() {
        ...
        return (
            <div className="screen-container fixed-header template-6" style={{ overflow: 'hidden', fontFamily: 'serif', textAlign: 'center', backgroundColor: theme.background}}>
                ...
                <div style={{  borderColor: theme.foreground, marginTop: 80}}>
                    {website.events &&
