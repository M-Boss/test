        ...
        return (
            <div className="template-6" style={{overflow: 'hidden'}}>
                ...
                <div style={{
                    ...
                    <p className="cursive" style={{margin: 0, marginTop: 20, marginBottom: 16, fontSize: 16}}>And</p>
                    <h1 className="" style={{
                ...
                <React.Fragment>
                    <div style={{
                        ...
                        <div style={{padding: 24, paddingTop: 40}}>
                            <h3 className="cursive" style={{fontSize: 18, color: 'rgba(0,0,0, 0.3)'}}>Son Of</h3>
                            <h2 style={{
                                color: theme.foreground,
                                marginTop: -14
                            }}>{website.groom_father + " & " + website.groom_mother}</h2>
                            <h3 className="cursive" style={{fontSize: 18, color: 'rgba(0,0,0, 0.3)'}}>Daughter Of</h3>
                            <h2 style={{
                                color: theme.foreground,
                                marginTop: -14
                ...
                <div style={{ position: 'relative', backgroundColor: theme.background, textAlign: 'center', marginTop: 100,  padding: 24, paddingTop: 0, paddingBottom: 0}}>
                    {website.stories && website.stories.map((story, i) => {
                        return (<div style={{
                            ...
                            <h1 className="cursive" style={{color: theme.foreground, marginTop: 10}}>{website.stories[i].title}</h1>
                            <p style={{
                                color: theme.foreground,
                                marginTop: -10
