        ...
        return (
            <div className="template-4" style={{overflow: 'hidden'}}>
                ...
                <div style={{
                    ...
                    <img width={90} style={{position: 'absolute', left: 0, top: 0, opacity: 0.9}} src={require('./assets/left.png')}/>
                    <img width={80} style={{position: 'absolute', right: 0, bottom: -70,  opacity: 0.9}} src={require('./assets/right.png')}/>
                    <h1 className=""
                ...
                <div style={{ backgroundColor: theme.background, textAlign: 'center', marginTop: 100,  padding: 24, paddingTop: 0, paddingBottom: 0}}>
                    {website.stories && website.stories.map((story, i) => {
                        return (<div style={{
                            ...
                            {i != website.stories.length -1 && <div style={{ display: 'inline-block', backgroundColor: theme.foreground,  height: 2, width: 100}} />}
                        </div>)
                    })}
                </div>
