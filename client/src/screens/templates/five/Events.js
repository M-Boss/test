...
class Events extends Component {
    ...
    render() {
        ...
        return (
            <div className="screen-container fixed-header template-5" style={{ overflow: 'hidden', fontFamily: 'serif', textAlign: 'center', backgroundColor: theme.background}}>
                ...
                <div style={{ borderBottom: '3px solid', borderColor: theme.foreground, marginTop: 80}}>
                    {website.events &&
